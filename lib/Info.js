...
export const skills = [
  ...
  },
  {
    ...
    title: "MERN stack",
    description:
      "I'm comfortable using MERN stack for building fully functional website.I'm expanding my knowledge on full-stack development. ",
    img: [
      {
        id: 1,
        src: "/assets/mongodb.png",
...
export const projects = [
  ...
  {
    type: "Full-stack Product Mvp",
    title: "Genki Attendance System",
    summary: "#NextJs #Tailwind #Prisma #ShadCN #MongoDb",
    description:
      "Mvp product for office attendance system.Admin panel for managing all the employees' checkin and checkout, leave system for employees, available in 4 languages (english,myanmar,japanese,vietnemese),email invitation system for organization and employees",
    img: "/assets/genki.PNG",
    link: "https://genki-attendance.vercel.app/",
    github:
      "https://github.com/SattPaingDtn/genki-attendance",
  },
  {
    ...
    description:
      "Functional Online Booking Website where u can create actual booking (site not available currently)",
    link: "https://booking-app-demo.vercel.app/",
    github: "https://github.com/ThanHtikeZawGithub/Booking-App-Demo",
  },
  {
    type: "Iacs Client's Website",
    title: "IACS",
    summary: "#PHP #Wordpress #Css #Javascript #Spectra",
    img: "/assets/iacs-personal.PNG",
    description:
      "Develop Custom theme for exisitng html and css client website using Wordpress Custom Block Themes Development.",
    link: "https://iacs.jp/",
    github: "https://github.com/SattPaingDtn/IACS",
  },
  {
  ...
  {
    type:"SDG Client's Website",
    title:"SDGs Sustainable JP",
    img:"/assets/sdg.PNG",
    summary:"#Wordpress #PHP #Javascript #Spectra #CustomTheme",
    description:"Develop and design custom theme for website of one of the big company in japan using wordpress",
    link:"http://genkisystem-test.sakura.ne.jp/test",
    github:"#",
  },
];
