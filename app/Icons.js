...
export const Arrow = ({className,...rest}) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg"
      ...
      <path
        fill="#134563"
        d="M-210.9-289l-2-2 11.8-11.7-11.8-11.7 2-2 13.8 13.7-13.8 13.7"
...
export const InstagramIcon = ({className,...rest}) => (
    ...
    >
      <defs>
        ...
        <radialGradient id="d" cx={27.5} cy={-41.5} r={148.5} xlinkHref="#a" />
        <radialGradient id="f" cx={13.87} cy={303.38} r={185.63} xlinkHref="#a" />
        <radialGradient id="j" cx={13.87} cy={-22.62} r={185.63} xlinkHref="#a" />
      </defs>
      <g clipPath="url(#b)">
